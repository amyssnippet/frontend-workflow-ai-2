  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="p-8 bg-white dark:bg-gray-800 rounded shadow text-center max-w-md">
        ...
        <p className="mt-4 text-sm text-gray-600">A verification link was sent to <strong>{email}</strong>. Please check your inbox and click the link to verify your account.</p>
        <button onClick={resend} className="mt-6 px-4 py-2 bg-indigo-600 text-white rounded">Resend verification</button>
      </div>
    </div>
  )
}
